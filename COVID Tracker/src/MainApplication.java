...
public class MainApplication extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        Label l2 = new Label("I present you my Coronavirus Response Tracker. Some functions of this great tool include the addition and reduction \nof covid cases to see its impact on the degree of cases in the state. A key feature that this program provides \nbut others don't is that this program can declare if states are safe or unsafe based on the amount of cases.");
